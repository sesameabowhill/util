...
[ 'github-api', '1.84', true ],
   ...
   [ 'zapper', '1.0.7', false ],
   [ 'gradle', '1.25', false ],
[ 'pipeline-stage-view', '2.4', false ],
[ 'pipeline-build-step', '2.4', true ],
[ 'workflow-durable-task-step', '2.8', true ],
   [ 'pipeline-stage-step', '2.2', true ],
[ 'workflow-support', '2.12', true ],
[ 'workflow-basic-steps', '2.3', true ],
[ 'pipeline-input-step', '2.5', true ],
[ 'workflow-job', '2.9', true ],
[ 'workflow-step-api', '2.7', false ],
[ 'workflow-cps', '2.24', false ],
[ 'workflow-cps-global-lib', '2.5', false ],
[ 'pipeline-graph-analysis', '1.3', true ],
[ 'workflow-multibranch', '2.9.2', true ],
[ 'branch-api', '1.11.1', false ],
...
[ 'cloudbees-folder', '5.16', true ],
   [ 'mailer', nil, true ],
   [ 'email-ext', nil, false ],
   [ 'matrix-auth', nil, false ],
[ 'matrix-project', '1.8', false ],
