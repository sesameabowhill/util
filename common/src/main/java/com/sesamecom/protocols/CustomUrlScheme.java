...
// compliments of: http://stackoverflow.com/questions/861500/url-to-load-resources-from-the-classpath-in-java
...
/**
 * Allows you to add your own URL handler without running into problems of race conditions with setURLStream handler.
 * <p/>
 * To add your custom protocol eg myprot://blahblah:
 * <p/>
 * 1) Create a new protocol package which ends in myprot eg com.myfirm.protocols.myprot 2) Create a subclass of
 * URLStreamHandler called Handler in this package 3) Before you use the protocol, call
 * CustomURLScheme.add(com.myfirm.protocols.myprot.Handler.class);
 *
 * @author jasonw
 */
public class CustomUrlScheme {
     ...
     * @throws Exception
     */
    public static void add(Class<? extends URLStreamHandler> handlerClass) throws CustomUrlHandlerException {
